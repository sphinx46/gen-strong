...
public class CommandFactory {
    ...
    private void registerCommands() {
        commandList.forEach(command -> {
            ...
            } else if (command instanceof ru.cs.vsu.social_network.telegram_bot.service.command.impl.TrainingPlanCommand) {
                commands.put("trainingplan", command);
                commands.put("тренировочныйплан", command);
            }
        });
